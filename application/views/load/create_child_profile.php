...
<body>
    ...
    <?php include('parentnavigation.php'); ?>
        ...
        <?php echo form_open('work/add_child', ['class'=>'form-horizontal']);?> <!--form open-->
          <?php echo form_hidden('parent_id',$this->session->userdata('user_id')); ?>
          
          <fieldset style="border:1px solid #3e0d3e; background-color:Aquamarine;">            
            <legend style="padding: 0.2em 0.5em; border:5px solid #3e0d3e; color:#3e0d3e; font-size:90%; text-align:Center; background-color:AntiqueWhite ;"><h2>Create Child Profile</h2></legend>
